...
**b) Organization Utilization and Location**
...
**c) Healthcare coverage and the White Race**
...
**d) Healthcare coverage and gender**
...
**a) Patients** - This table containesl the details of the each patient who visited the hospital.  The details captured include Inique ID, names, date of birth, Social Security Number, Passport Number, Birth Date, Death Date, Maiden name, Race, Marital Status, birth place etc. 

**b) Encounters** - This data captures each hospital visit called an encounter. It captures a unique ID, start and end of the encounter, Duration, Patients Age, name, Birth Date, Death Date, Gender, Marital Status, Patients Coverage, Hospital Name etc. This is the main table that brings together data from all the other tables.

**c) Providers** - This date captures the details of the health care provider. It captures Hospital Name, City, Doctor's Name, Gender, Speciality etc

**d) Payers** - This data captures details of insurance provider

**e) Payer_transitions** - This file captures data that links patients data and the insurance providers data

**f) Organizations** - This file captures data of the healthcare facility
...
a) This code was used to classify the patients into various age groups.
...
b) This is an example of a stored procedure that was created to retrieve the details of all patients under an a particular healthcare provider
...
END $$ 
```
c) This sql code was used to classify the data by encounter class, give a total of each encounter class, and the cost of each encounter class
```
